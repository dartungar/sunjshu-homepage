  ...
  return (
    <section>
      <AboutContainer id="about">
        ...
        <TextContainer>
          <h2>Привет, меня зовут Юлия.</h2>
          <p>
            Ваша жизнь полна чудесных моментов. Я помогу сохранить их навсегда и
            рассказать вашу уникальную историю в фотографиях.
          </p>
          <p>
          ...
          <p>
            ...
            или простую прогулку - напишите или позвоните:
          </p>
          <SocialLinks />
        </TextContainer>
      </AboutContainer>
